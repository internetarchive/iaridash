...
//
    const REF_LINK_SELECTOR = window.tw_REF_LINK_SELECTOR || '.reference, a[href^="#CITEREF"]',
...
// } );
    ...
    function testwiki( $content ) {

        console.log("TestWiki encountered!!!")
    ...
    settingsString = mw.cookie.get( 'TESTWIKIsettings', '' );
    if ( settingsString ) {
    ...
    mw.hook( 'wikipage.content' ).add( testwiki );
